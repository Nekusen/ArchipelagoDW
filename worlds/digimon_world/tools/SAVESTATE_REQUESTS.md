...
| `gekomon_talk.state` | Vanilla ISO, screen 141 `GKYO02`, tamer beside `.MAP` record 3 (532, 0, -1195), trigger 205 clear, no dialog -- `dw1_warp_state.py --map 141` + the entity teleport recipe; one input: CROSS | The Gekomon location splice (Script 135 vm 5562): bit 780 set only through the joined dialog. |
